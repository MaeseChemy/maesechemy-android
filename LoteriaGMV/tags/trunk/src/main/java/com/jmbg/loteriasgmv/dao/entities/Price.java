...
public class Price extends AbstractEntity implements
		PriceBaseColumns, Comparable<Price>{
	...
	public static final String SQL_CREATE = "CREATE TABLE " + TABLE_NAME + " ("
			...
			+ FIELD_PRICE_TYPE + " TEXT, " 
			+ FIELD_PRICE_DATE + " TEXT, " 
			+ FIELD_PRICE_NUMBERS + " TEXT, "
			+ FIELD_PRICE_NEXT_DATE + " TEXT, "
			+ FIELD_PRICE_NEXT_POT + " INTEGER" + "); "
			+ "CREATE INDEX IF NOT EXISTS IDX_" + TABLE_NAME + "_" + FIELD_PRICE_DATE + " ON TABLE_NAME (" + FIELD_PRICE_DATE + ");";
	...
	public String toString() {
		...
		sb.append("[").append("priceType").append("=").append(this.priceType).append("]");
		sb.append("[").append("priceDate").append("=").append(this.priceDate).append("]");
		sb.append("[").append("priceNumbers").append("=").append(this.priceNumbers).append("]");
		sb.append("[").append("priceNextDate").append("=").append(this.priceNextDate).append("]");
		sb.append("[").append("priceNextPot").append("=").append(this.priceNextPot).append("]");
	...
	public int compareTo(Price another) {
		int compare = this.getPriceDateAsDate().compareTo(another.getPriceDateAsDate());
		return compare; 
	}
	...
	public Ticket getTicketPrice(){
		...
		if(this.getPriceType() == "Euromillones"){
			ticket.setType(TypeTicket.EUROMILLONES);
		}else if(this.getPriceType() == "Primitiva"){
