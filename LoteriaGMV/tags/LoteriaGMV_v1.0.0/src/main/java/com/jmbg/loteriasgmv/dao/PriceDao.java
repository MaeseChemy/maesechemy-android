...
public class PriceDao extends AbstractDao<Price> {
	...
	protected Price cursorToEntity(Cursor cursor) {
		...
		entity.setPriceType(cursor.getString(cursor.getColumnIndex(Price.FIELD_PRICE_TYPE)));
		entity.setPriceDate(cursor.getString(cursor.getColumnIndex(Price.FIELD_PRICE_DATE)));
		entity.setPriceNumbers(cursor.getString(cursor.getColumnIndex(Price.FIELD_PRICE_NUMBERS)));
		entity.setPriceNextDate(cursor.getString(cursor.getColumnIndex(Price.FIELD_PRICE_NEXT_DATE)));
		entity.setPriceNextPot(cursor.getInt(cursor.getColumnIndex(Price.FIELD_PRICE_NEXT_POT)));
	...
	protected ContentValues entityToContentValues(Price entity) {
		...
		contentValues.put(Price.FIELD_PRICE_NEXT_DATE, entity.getPriceNextDate());
