package com.jmbg.oldgloriescalendar.login;
...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.sign_in_invitado_button).setOnClickListener(
				new View.OnClickListener() {
					@Override
					public void onClick(View view) {
						access(false);
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			return login.doLogin(mUsername, mPassword);
		}
	...
	public void access(boolean jugador) {
		Log.d(Constantes.TAG, "[" + LoginActivity.class.getName()
				+ ".access] Accediendo a la app...");
		if(jugador)
			SaveSharedPreference.setUserName(this, formatearNombre(mUsername));
		else
